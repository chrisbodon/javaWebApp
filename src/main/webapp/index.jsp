...
<body>
    ...
    <form action="sumar" method="POST">
		...
		<label for="operacion">Tipo de operación</label><br>
		<input type="radio" name="op" value="1"> Sumar<br>
		...
		<p><input type="number" name="op1" placeholder="Número 1" autofocus required></p>
		<p><input type="number" name="op2" placeholder="Número 2" required></p>
